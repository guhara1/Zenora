...
# ── 검색엔진 소유확인·색인 ────────────────────────────────────
# 네이버 서치어드바이저 / 구글 서치콘솔 사이트 소유확인 메타 태그.
# 값이 비어 있으면 해당 메타는 출력하지 않는다.
NAVER_VERIFY = "beb05ec974f01818e484f90ef76e6748b6596391"
GOOGLE_VERIFY = ""   # 구글 서치콘솔 HTML 태그 방식 사용 시 content 값 입력
# IndexNow 키 (네이버·Bing 즉시 색인 제출용). /{key}.txt 로도 노출된다.
INDEXNOW_KEY = "a1b2c3d4e5f64708a9b0c1d2e3f40516"
